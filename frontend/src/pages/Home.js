...
export const Home = () => {
  ...
  const OneFeature = ({ title, text }) => (
    <div className="w-full md:w-1/2 lg:w-1/3 px-4">
      <div className="mb-[70px] wow fadeInUp text-center" data-wow-delay=".15s">
        <div
          className="w-[70px] h-[70px] flex items-center justify-center mx-auto rounded-md bg-primary
    ...
    <Layout>
      ...
      >
        <div className="container">
          ...
          <div className="flex flex-wrap mx-[-16px]">
            <OneFeature title={"Crafted for Startups"} text={"..."}/>
            <OneFeature title={"Crafted for Startups"} text={"..."}/>
            <OneFeature title={"Crafted for Startups"} text={"..."}/>
            <OneFeature title={"Crafted for Startups"} text={"..."}/>
            <OneFeature title={"Crafted for Startups"} text={"..."}/>
